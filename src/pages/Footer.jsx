              ...
              <div className="mb-10 w-full">
                <a href="/#" className="mb-6 inline-block max-w-[160px]">
                  <img
                    src={wama}
                    alt="logo"
                    className="w-full h-20 dark:hidden"
                  />
                  <img
                ...
                WAMA Consultancy, where passion meets expertise in three diverse yet interconnected domains.
                </p>
