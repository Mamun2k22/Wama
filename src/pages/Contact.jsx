...
const Contact = () => {
    return (
        ...
        <div class="inline-flex items-center justify-center w-12 h-12 mb-6 text-gray-100 bg-blue-700 rounded-full dark:bg-blue-500">
        ...
        Email</h2>
        <a href="#" class="text-base font-medium text-gray-500 md:text-lg dark:text-gray-400">ITcompany@gmail.com</a>
        </div>
        </div>
        <div class="w-full px-4 mb-10 sm:w-1/2">
        <div class="max-w-xs mx-auto">
        ...
        <h2 class="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl dark:text-gray-400">
        Phone</h2>
        <a href="#" class="text-base font-medium text-gray-500 md:text-lg dark:text-gray-400">+9876542312</a>
        </div>
        </div>
        <div class="w-full px-4 mb-10 sm:w-1/2">
        <div class="max-w-xs mx-auto">
                ...
                <form action="" class="">
                    <div class="flex flex-wrap mb-6">
                        <div class="w-full px-3 md:w-1/2 md:mb-0">
                            ...
                            <input type="text" placeholder="first name" required
                                className="block w-full px-4 py-3 mb-3 leading-tight text-gray-700 bg-gray-100 border rounded lg:mb-0 dark:text-gray-400 dark:border-gray-800 dark:bg-gray-800 outline-none  hover:border-blue-500 "/>
                        </div>
                        <div class="w-full px-3 md:w-1/2 md:mb-0">
                            <label for="firstname"
                                class="block mb-2 font-bold text-gray-700 uppercase dark:text-gray-400">
                            ...
                            <input type="text" placeholder="last name" required
                                class="block w-full px-4 py-3 mb-3 leading-tight text-gray-700 bg-gray-100 border rounded dark:placeholder-gray-500 lg:mb-0 dark:text-gray-400 dark:border-gray-800 dark:bg-gray-800 outline-none  hover:border-blue-500 "/>
                        </div>
                    </div>
                    <div class="px-3 mb-6">
                        ...
                        <input type="text" placeholder="abc@gmail.com" required
                            class="block w-full px-4 py-3 mb-3 leading-tight text-gray-700 bg-gray-100 border rounded dark:placeholder-gray-500 dark:text-gray-400 dark:border-gray-800 dark:bg-gray-800 outline-none  hover:border-blue-500"/>
                    </div>
                    <div class="px-3 mb-6">
                        <label for="firstname" class="block mb-2 font-bold text-gray-700 uppercase dark:text-gray-400">
                            Subject</label>
                    ...
                    <div class="px-3 mb-6">
                        ...
                        <textarea type="message" placeholder="Describe your problem" required
                            class="block w-full px-4 leading-tight text-gray-700 bg-gray-100 rounded dark:placeholder-gray-500 py-7 dark:text-gray-400 dark:border-gray-800 dark:bg-gray-800 outline-none  border border-blue-500 "></textarea>
                    </div>
                    <div class="px-3">
                        <button
