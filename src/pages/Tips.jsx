...
const Tips = () => {
    return (
        <div >
            ...
            {/* Tips Card here */}
            <div id='Tips' class="bg-white py-12">
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-5xl lg:text-center flex flex-col justify-center items-center">
     
      <h1 class="lg:text-3xl text-3xl md:text-3xl font-bold tracking-tight text-gray-900 text-center">
        <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-blue-800 to-gray-900">Tips</span>
      </h1>
      <div className='bg-blue-700 w-16 h-[2px] mt-2 '></div>
    </div>
